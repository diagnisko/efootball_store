...
export const metadata = { title: "Conditions d'utilisation — MISTER DOU" };
    ...
    <div className="dash" style={{ maxWidth: 760 }}>
      ...
      <div className="panel card" style={{ borderColor: "var(--warn)", marginBottom: 22 }}>
        <p style={{ fontSize: 13, color: "var(--muted)", display: "flex", gap: 8, alignItems: "flex-start" }}>
          ...
          <strong> pas un document juridique valide</strong>. MISTER DOU traite des paiements et des
      ...
      <div className="panel card" style={{ fontSize: 14, color: "var(--muted)", lineHeight: 1.7 }}>
        <h3>1. Objet</h3>
        <p>MISTER DOU met en relation des vendeurs et des acheteurs de comptes de jeu vérifiés, avec un paiement échelonné.</p>
        ...
        <h3>5. Résiliation</h3>
        <p>MISTER DOU se réserve le droit de suspendre un compte en cas de retard de paiement prolongé ou de fraude avérée.</p>
      </div>
    </div>
  );
}
