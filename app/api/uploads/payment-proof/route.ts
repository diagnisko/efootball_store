...
import { createPaymentProofUploadPost, StorageNotConfiguredError } from "@/lib/storage";
...
export async function POST(req: Request) {
  ...
  try {
    const result = await createPaymentProofUploadPost(userId, fileName, contentType);
